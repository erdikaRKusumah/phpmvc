				...
				<ul class="list-group ">
					<?php foreach ($data['mhs'] as $mhs) : ?>
							  <li class="list-group-item"> 
							  	...
							  	<a href="<?= BASEURL; ?>/mahasiswa/hapus/<?= $mhs['id']; ?>" class="badge badge-danger float-right ml-1" onclick="return confirm('apakah anda yakin ingin menghapus <?= $mhs['nama'];?>?')">Hapus</a>
